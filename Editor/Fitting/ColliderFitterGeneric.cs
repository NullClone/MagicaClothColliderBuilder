...
namespace MagicaClothColliderBuilder
{
    ...
    {
        public static bool TryFitLimb(ColliderGenerationJob job, Vector3 childHint, BoneFitRole boneRole, ref FitResult fitResult)
        {
        ...
        public static bool TryFitAuto(ColliderGenerationJob job, Vector3[] vertices, BoneFitRole boneRole, bool hasChildHint, Vector3 childHint, bool hasParentHint, Vector3 parentHint, out FitResult fitResult)
        {
            fitResult = default;
